...
import { Activity, BookOpen, CalendarDays, ClipboardCheck, Clock3, LayoutDashboard, LogOut, PanelLeft, Radar, ScrollText, ShieldCheck, Trophy, ListChecks } from "lucide-react";
...
const menuItems = [
  ...
  { icon: ListChecks, label: "V7 Audit", path: "/v7-audit" },
  { icon: Activity, label: "Monitoring", path: "/monitoring" },
  { icon: Trophy, label: "Winning rate", path: "/winning-rate" },
  { icon: Clock3, label: "Best Time to Trade", path: "/best-time-to-trade" },
  { icon: CalendarDays, label: "Best Days to Trade", path: "/best-days-to-trade" },
];
        ...
        >
          <SidebarHeader className="h-16 justify-center">
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              >
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary text-primary-foreground"><ShieldCheck className="h-4 w-4" /></div>
              </button>
              {!isCollapsed ? (
